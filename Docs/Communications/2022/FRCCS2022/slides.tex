...
% ? - if no result, LHS? bof. - local algo?
...
\textit{Work in progress:} empirical stylised facts on possible trade-offs in systems of cities; model parametrisation with real data (patents and spatialised emissions).
...
\begin{enumerate}
    ...
    \item Many-objective optimisation: NSGA3 algorithm
    \item Towards mmulti-scale models: goal 11
\end{enumerate}
...
$\rightarrow$ Towards an integrative urban (territorial?) science applied to sustainable planning at multiple scales
